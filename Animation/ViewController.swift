...
class ViewController: UIViewController {
    ...
    var circle = UIView(frame: CGRect(x: 0, y: 100, width: 40, height: 40))
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.addSubview(circle)
        circle.backgroundColor = UIColor(red: 104/255, green: 134/255, blue: 1, alpha: 1.0)
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if let cell = categoryCollectionView.cellForItem(at: indexpath) as? CategoryCell {
            ...
            circle.frame.origin.x = labelPosition
            circle.frame.origin.y = categoryCollectionView.frame.origin.y + 15
